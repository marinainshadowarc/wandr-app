...
const TYPE_ICONS = { flight: <PlaneSticker size={15} />, hotel: '🏨', food: '🍜', activity: '🎯', transport: '🚆' };
                ...
                <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  {item.type === 'flight' && item.flight_number && (
                    <p style={{ fontSize: 12, color: 'var(--text-muted)' }}>
                      <PlaneSticker size={13} /> {item.airline} {item.flight_number} · {item.departure_airport} → {item.arrival_airport}
                    </p>
                  )}
                </div>
              )}
